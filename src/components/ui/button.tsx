...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive active:scale-95 select-none",
  {
    variants: {
      ...
      size: {
        default: "h-11 min-w-[48px] px-4 py-3 has-[>svg]:px-3",
        sm: "h-10 min-w-[44px] rounded-md gap-1.5 px-3 py-2 has-[>svg]:px-2.5",
        lg: "h-12 min-w-[52px] rounded-md px-6 py-4 has-[>svg]:px-4",
        xl: "h-14 min-w-[56px] rounded-md px-8 py-4 text-base has-[>svg]:px-6",
        icon: "size-11 min-w-[44px]",
        "icon-sm": "size-10 min-w-[40px]",
